...
def main(config):
    ...
    if config.model_params.fwd_type == 'rece':
        base_config['n_buckets'] = config.model_params.n_buckets
        base_config['buckets_per_chunk'] = config.model_params.buckets_per_chunk
        base_config['n_extra_chunks'] = config.model_params.n_extra_chunks
        base_config['rounds'] = config.model_params.rounds

    device = 'cuda'
    training, data_description, _, testset_valid, testset_, holdout_valid, holdout_ = \
